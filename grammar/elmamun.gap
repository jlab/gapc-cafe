...
HEADER
<h1>El Mamun's Caravan</h1>
Find the optimal placement of parentheses in a term under some optimization strategy.
<br/>
El Mamun's Problem might be <a target="_blank" href="http://bibiserv.techfak.uni-bielefeld.de/dpcourse/src/elmamun.pdf">one of the oldest known dynamic programming problems</a>.
HEADER
